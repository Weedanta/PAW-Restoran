...
const Description2 = () => {
    return (
        <section className='h-full md:h-screen w-full md:p-28 p-4 bg-primary-2 flex   items-center' >
            <div className="w-full flex justify-between items-center gap-4 md:gap-10 lg:gap-16 flex-col-reverse md:flex-row">
                <article className='text-white flex flex-col text-center md:text-justify gap-6 md:gap-10 px-10 md:px-0'>
